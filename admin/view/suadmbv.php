...
<body>
  ...
  <div class="conttent">
      ...
      <div class="top_col3">
        ...
        <form action="index.php?act=capnhat_dmbv" method="post">
                <label for="">Cập nhật danh mục loại bài viết</label>
                <br>
                ...
                <input type="text" name="dmbv" placeholder="Nhập danh mục" value="<?=$dmbaiviet?>">
                <input type="hidden"  name="id" value="<?=$id?>">  
                <br>   
                <br>       
                <input style="width:100px;" type="submit" name="capnhat_dmbv" value="Cập nhật">    
            </form>
            </div>
      </div>
      <div class="right">
